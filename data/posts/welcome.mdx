...
Hey there <span aria-label='peace out emoji' role="img">✌️</span>
...
Thanks again for taking the time to read this. It's also worth mentioning that this is an open-source project, so if you wish to contribute in any way, I'm only a pr away <span aria-label="wink emoji" role="img">😉</span> .
